            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row">
                    ...
                    ?>
                        ...
                        ?>
                            <a href="Agent.php?NewAgent" class="btn btn-primary w-100 shadow">Nouveau Agent</a>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href='Agent.php?NewAgent&idAgent=<?= $Agent['id'] ?>' class="btn btn-sm btn-primary mt-1">
